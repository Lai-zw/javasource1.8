...
public class XMLEntityManager implements XMLComponent, XMLEntityResolver {
    ...
    public void reset() {
        ...
        if (DEBUG_ENTITIES) {
            ...
            try {
                addExternalEntity("external-text", null, "external-text.ent", "com/laizhw/project/external-text.xml");
                addExternalEntity("external-balanced-element", null, "external-balanced-element.ent", "com/laizhw/project/external-balanced-element.xml");
                addExternalEntity("one", null, "ent/one.ent", "com/laizhw/project/external-entity.xml");
                addExternalEntity("two", null, "ent/two.ent", "com/laizhw/project/ent/one.xml");
            }
            catch (IOException ex) {
                // should never happen
            }
