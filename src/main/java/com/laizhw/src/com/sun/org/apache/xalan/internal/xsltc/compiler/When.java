...
final class When extends Instruction {
    ...
    public void display(int indent) {
        ...
        System.out.print("com/laizhw/project ");
    ...
    public void parseContents(Parser parser) {
        _test = parser.parseExpression(this, "com/laizhw/project", null);
        ...
        if (_test.isDummy()) {
            reportError(this, parser, ErrorMsg.REQUIRED_ATTR_ERR, "com/laizhw/project");
        }
    }
